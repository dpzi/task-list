...
export const show = (readline : any,tasks : TaskProps) => {
...
export const today = (readline : any,tasks : TaskProps) => {
    forEachProject((project, taskList) => {
        println(project, readline);
        taskList.forEach((task) => {
...
export const deadline = (commandLine: string, readline: any, tasks: TaskProps) => {
...
export const add = (commandLine: string, readline: any , tasks : TaskProps) => {
    var subcommandRest = splitFirstSpace(commandLine);
    ...
    if (subcommand === "project") {
        ...
        addTask(projectTask[0], idString[0], idString[1], tasks, readline);
    }
}

const addTask = (project: string, description: string, idString: string, tasks : TaskProps, readline: any) => {
...
const addProject = (name: string, tasks: TaskProps) => {
    tasks[name] = [];
}

export const view = (commandLine: string,  readline: any, tasks: TaskProps) => {
    var subcommandRest = splitFirstSpace(commandLine);
    var subCommand = subcommandRest[0];
...
export const deleteTask = (idString: string, readline: any, tasks: TaskProps) => {
...
export const check = (idString: string, readline : any, tasks: TaskProps) => {
    setDone(idString, true, readline, tasks);
}

export const uncheck = (idString: string, readline : any, tasks: TaskProps) => {
    setDone(idString, false, readline, tasks);
}

const setDone = (idString: string, done: boolean, readline: any, tasks: TaskProps) => {
    var found = false;
    forEachProject((project, taskList) => {
        taskList.forEach((task) => {
            if (task.id == idString) {
...
export const error = (command: string, readline) => {
